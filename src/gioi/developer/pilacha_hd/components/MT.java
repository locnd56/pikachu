...
/**
 * Dựa vào màn hình tính toán xem có bao nhiêu hàng, cột Tạo ra ma trận ngẫu
 * nhiên ban đầu Tạo ra ma trận test khi cần
 * 
...
public class MT {
	...
	public static void getTotalRowColumn(int ystart) {
		int height_content = Config.SCREENHEIGHT - ystart - Config.ITEM_HEIGHT
				/ 2;
