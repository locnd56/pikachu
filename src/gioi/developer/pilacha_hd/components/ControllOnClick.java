...
/**
 * Quản lý việc so sánh kiểm tra xem có ăn được ko, có các phương thức ktra 2 vị trí có ăn được ko. 
...
/**
 * - Quản lý việc click lên các đối tượng piakchu. - Kiểm tra xem 2 đối tượng có
 * ăn được không. - Nếu trường hợp không còn đối tượng pikachu ăn được thì hoản
