...
/**
 * Class này thể hiện trạng thái thời gian, nó có 2 phần, 1 phần nằm trên tạo
 * lớp vỏ bọc, 1 cái hình chữ nhật bên dưới có màu đỏ để tạo ra hiệu ứng thời
 * gian chạy ngược. Sau 1s thì cái hình chữ nhật lại được cập nhật lại chiều
 * rộng của nó. Nó sẽ thu nhỏ chiều rộng
 * 
...
/**
 * Hiện thị quá trình thời gian chạy ngược
 * 
 * @author VAN GIOI
 *
 */
