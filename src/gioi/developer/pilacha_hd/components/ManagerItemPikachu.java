...
/**
 * Quản lý các đối tượng pikachu, quản lý việc ăn, việc di chuyển các đối tượng,
 * tạo các hiệu ứng
 * 
...
public class ManagerItemPikachu {
	...
	public void showItemEffect(int effects, int type) {
		for (int i = 0; i < list_itemPikachu.size(); i++) {
			...
			// In bottom
			case 3:
				mItemPikachu.move(mItemPikachu.X, Config.SCREENHEIGHT + 100,
						type);
				break;
			// In left-top
			case 4:
			...
			// In left-bottom
			case 6:
				mItemPikachu.move(-100, Config.SCREENHEIGHT + 100, type);
				break;
			// In right-bottom
			case 7:
				mItemPikachu.move(Config.SCREENWIDTH + 100,
						Config.SCREENHEIGHT + 100, type);
				break;
			default:
				break;
			}
    ...
    */
	...
	// ----------------------------------------
	/**
	 * Di chuyển từ trên xuống dưới Move top - down
	 * 
	 * @param i1
	 * @param j1
	 * @param i2
	...
	// ----------------------------------------
	/**
	 * Di chuyển từ dưới lên trên Move down - top
	 * 
	 * @param i1
	 * @param j1
	 * @param i2
	...
	// ----------------------------------------
	/**
	 * Di chuyển từ trái qua phải Move left - right
	 * 
	 * @param i1
	 * @param j1
	 * @param i2
	...
	// ----------------------------------------
	/**
	 * Di chuyển từ phải qua trái Move right - left
	 * 
	 * @param i1
	 * @param j1
	 * @param i2
