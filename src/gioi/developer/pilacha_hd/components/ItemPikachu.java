...
/**
 * Định nghĩa 1 đối tượng pikachu, nó có các thuộc tính quan trọng như vị trí
 * hàng, vị trí cột, ví trí hiển thị theo trục x, vị trí hiển thị theo trục
 * y,GT_ITEM: Xác định xem đối tượng này hiển thị ảnh gì.
 * 
...
public class ItemPikachu extends MySprite {
    ...
    * I : Vị trí hàng
    * J : Vị trí cột
    * GT_ITEM : Xác định xem pikachu này là bức ảnh nào, dùng ánh xạ hiện thị ảnh.
    * X : Vị trí X trên màn hình
    * Y : Vị trí Y trên màn hình
    */
    ...
    public void onLoadResources() {   
        if(!ManagerItemPikachu.map_Resources.containsKey(GT_ITEM)){
            ...
            this.item_TR = BitmapTextureAtlasTextureRegionFactory.createFromAsset(this.item_BTA, mContext, Config.pathTHEME + "item" + GT_ITEM+ ".png", 0, 0);
    ...
    // ------------------------------------------
    public void newItemPikachu(Scene mScene, int i, int j, int gt_item, int x,
            int y) {
        this.I = i;
        this.J = j;
    ...
    /**
    * Tạo ra hiệu ứng di chuyển từ vị trí hiện tại của đối tượng piakchu
    * tới vị trí x, y
    *
    * effect_type = 1 => IN : Di chuyển từ ngoài vào
    * effect_type != 1 => Out : Di chuyển từ trong ra
    * @param x
    * @param y
    * @param effect_type
    */
    ...
    */
    public void moveXY(int x, int y){
        ...
        SequenceEntityModifier modifier = new SequenceEntityModifier(new SequenceEntityModifier.IEntityModifierListener() {
            @Override
